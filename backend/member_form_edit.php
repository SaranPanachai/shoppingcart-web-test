...
<input type="hidden" name="member_id" value="<?php echo $member_id; ?>">
       ...
       <div class="form-group">
        ...
        <div class="form-group">
          <div class="col-sm-5" align="left">
            <input  name="m_name" type="text" required class="form-control" id="m_name" value="<?=$m_name;?>"placeholder=" Name-lastname " />
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-5" align="left">
            <input  name="m_email" type="email" class="form-control" id="m_email"  value="<?=$m_email;?>" placeholder=" Email "/>
          </div>
        </div>
        <div class="form-group">
          <div class="col-sm-5" align="left">
